...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-5897/121/artifact/org/jenkins-ci/main/jenkins-war/2.342-rc32323.ce278354da_0f/jenkins-war-2.342-rc32323.ce278354da_0f.war
        ;;
        "latest-rc")
