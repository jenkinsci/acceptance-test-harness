...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-5926/10/artifact/org/jenkins-ci/main/jenkins-war/2.322-rc31737.185803a3fe42/jenkins-war-2.322-rc31737.185803a3fe42.war
        ;;
        "latest-rc")
