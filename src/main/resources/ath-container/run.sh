...
if [ ! -f $war ]; then
    case "$war" in
        "latest")
            ...
            # TODO https://github.com/jenkinsci/jenkins/pull/7278
            url=https://repo.jenkins-ci.org/snapshots/org/jenkins-ci/main/jenkins-war/2.375-SNAPSHOT/jenkins-war-2.375-20221019.214955-1.war
        ;;
        "lts")
            war=jenkins-lts.war
