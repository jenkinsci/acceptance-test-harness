...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-6485/21/artifact/org/jenkins-ci/main/jenkins-war/2.347-rc32370.d72517d239b_4/jenkins-war-2.347-rc32370.d72517d239b_4.war
        ;;
        "latest-rc")
