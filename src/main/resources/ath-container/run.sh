...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-5897/36/artifact/org/jenkins-ci/main/jenkins-war/2.324-rc31833.d50603390fab/jenkins-war-2.324-rc31833.d50603390fab.war
        ;;
        "latest-rc")
