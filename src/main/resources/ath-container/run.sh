...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-6485/22/artifact/org/jenkins-ci/main/jenkins-war/2.347-rc32371.a_41474581597/jenkins-war-2.347-rc32371.a_41474581597.war
        ;;
        "latest-rc")
