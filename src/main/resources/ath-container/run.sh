...
if [ ! -f $war ]; then
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-7203/1/artifact/org/jenkins-ci/main/jenkins-war/2.372-rc32933.36da_fb_248642/jenkins-war-2.372-rc32933.36da_fb_248642.war
        ;;
        "lts")
            war=jenkins-lts.war
