...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-6687/2/artifact/org/jenkins-ci/main/jenkins-war/2.357-rc32478.e37b_59406830/jenkins-war-2.357-rc32478.e37b_59406830.war
        ;;
        "latest-rc")
