...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-5926/12/artifact/org/jenkins-ci/main/jenkins-war/2.323-rc31744.6335018022ea/jenkins-war-2.323-rc31744.6335018022ea.war
        ;;
        "latest-rc")
