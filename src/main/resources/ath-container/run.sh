...
if [ ! -f $war ]; then
    ...
    case "$war" in
	    ...
	    # https://github.com/jenkinsci/bom/pull/1098
            url=https://repo.jenkins-ci.org/incrementals/org/jenkins-ci/main/jenkins-war/2.346-rc32367.a_1d9b_855ca_2a_/jenkins-war-2.346-rc32367.a_1d9b_855ca_2a_.war
        ;;
        "latest-rc")
