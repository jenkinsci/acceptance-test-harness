...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-5897/119/artifact/org/jenkins-ci/main/jenkins-war/2.342-rc32321.d9f209eb_14b_b_/jenkins-war-2.342-rc32321.d9f209eb_14b_b_.war
        ;;
        "latest-rc")
