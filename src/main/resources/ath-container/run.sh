...
if [ ! -f $war ]; then
    ...
    case "$war" in
	    ...
	    # TODO https://github.com/jenkinsci/jenkins/pull/6579
            url=https://repo.jenkins-ci.org/incrementals/org/jenkins-ci/main/jenkins-war/2.348-rc32379.78fdea_0344d0/jenkins-war-2.348-rc32379.78fdea_0344d0.war
        ;;
        "latest-rc")
