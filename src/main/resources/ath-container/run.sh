...
if [ ! -f $war ]; then
    ...
    case "$war" in
	    ...
	    # https://github.com/jenkinsci/jenkins/pull/6055
            url=https://repo.jenkins-ci.org/incrementals/org/jenkins-ci/main/jenkins-war/2.326-rc31850.8a20f9c68e7b/jenkins-war-2.326-rc31850.8a20f9c68e7b.war
        ;;
        "latest-rc")
