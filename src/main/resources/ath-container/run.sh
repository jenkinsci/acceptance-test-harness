...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-5897/29/artifact/org/jenkins-ci/main/jenkins-war/2.323-rc31806.ba89f9adf136/jenkins-war-2.323-rc31806.ba89f9adf136.war
        ;;
        "latest-rc")
