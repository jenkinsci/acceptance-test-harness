...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-5923/62/artifact/org/jenkins-ci/main/jenkins-war/2.326-rc31999.a86620d1b7d7/jenkins-war-2.326-rc31999.a86620d1b7d7.war
        ;;
        "latest-rc")
