...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-6084/77/artifact/org/jenkins-ci/main/jenkins-war/2.338-rc32169.18a_13237a_ce0/jenkins-war-2.338-rc32169.18a_13237a_ce0.war
        ;;
        "latest-rc")
