...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-5923/73/artifact/org/jenkins-ci/main/jenkins-war/2.327-rc32059.2906b148d4b9/jenkins-war-2.327-rc32059.2906b148d4b9.war
        ;;
        "latest-rc")
