...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/job/PR-6527/lastSuccessfulBuild/artifact/org/jenkins-ci/main/jenkins-war/2.347-rc32357.891f43b_fd2c4/jenkins-war-2.347-rc32357.891f43b_fd2c4.war
        ;;
        "latest-rc")
