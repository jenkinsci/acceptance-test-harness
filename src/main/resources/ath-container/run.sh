...
if [ ! -f $war ]; then
    ...
    case "$war" in
        "latest")
            ...
            url=https://ci.jenkins.io/job/Core/job/jenkins/view/change-requests/job/PR-5897/85/artifact/org/jenkins-ci/main/jenkins-war/2.336-rc32156.b_766fd68d789/jenkins-war-2.336-rc32156.b_766fd68d789.war
        ;;
        "latest-rc")
