...
if [ ! -f $war ]; then
    ...
    case "$war" in
	    ...
	    # https://github.com/jenkinsci/jenkins/pull/6103
            url=https://repo.jenkins-ci.org/incrementals/org/jenkins-ci/main/jenkins-war/2.327-rc31894.13111dbdc40b/jenkins-war-2.327-rc31894.13111dbdc40b.war
        ;;
        "latest-rc")
