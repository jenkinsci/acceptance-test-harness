...
public class ManagedCredentialsBinding extends ContainerPageObject {
    ...
    public <T extends CredentialsBinding> T addCredentialBinding(final Class<T> type) {
        String path = createPageArea(
                "/org-jenkinsci-plugins-credentialsbinding-impl-SecretBuildWrapper/bindings", () -> control(
                                by.path(
                                        "/org-jenkinsci-plugins-credentialsbinding-impl-SecretBuildWrapper/hetero-list-add[bindings]"))
