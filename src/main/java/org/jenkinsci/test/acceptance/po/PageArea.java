 ...
 * <p/>
 * <p/>
 * Typically we use this to map a set of controls in the configuration page, which is generated by composing various
 * config.jelly files from different extension points.
 *
 * @author Oliver Gondza
 */
public abstract class PageArea extends CapybaraPortingLayerImpl implements Control.Owner {
    /**
